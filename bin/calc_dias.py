    ...
    for calculation in calculations:
        ...
        for year in range(calc_year_start, calc_year_stop+1):
            for month in range(calc_month_start, calc_month_stop+1):
                input_image_searchstr = f"/mnt/NAS3/CARD/FLANDERS/S1*/L1TC/{year}/{month:02d}/*/*.CARD"
        ...
        for year in range(calc_year_start, calc_year_stop+1):
            ...
            for month in range(month_start, month_stop+1):
                input_image_searchstr = f"/mnt/NAS3/CARD/FLANDERS/S2*/L2A/{year}/{month:02d}/*/*.SAFE"
        ...
        for year in range(calc_year_start, calc_year_stop+1):
            for month in range(calc_month_start, calc_month_stop+1):
                input_image_searchstr = f"/mnt/NAS3/CARD/FLANDERS/S1*/L1CO/{year}/{month:02d}/*/*.CARD"
                input_image_filepaths.extend(glob.glob(input_image_searchstr))  
